...
\Large{
  \begin{tabu}{ c l r }
   \multirow{5}{1in}{\includegraphics[width=0.88in]{avatar}} & \scshape{Bi Yilin} & {Python~}\progressbar{0.75} \\
    & \email{biyilin@bfsu.edu.cn} & {Scala~}\progressbar{0.5} \\
    & \phone{(+86) 180-8847-3962} & {Linux~}\progressbar{0.7} \\
